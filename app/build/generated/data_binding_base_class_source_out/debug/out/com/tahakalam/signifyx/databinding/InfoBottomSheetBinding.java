...
package com.tahakalam.signifyx.databinding;
...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull AppCompatSpinner spinnerDelegate, @NonNull AppCompatSpinner spinnerLanguage,
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AppCompatSpinner spinnerLanguage = ViewBindings.findChildViewById(rootView, id);
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          ...
          presenceThresholdValue, spinnerDelegate, spinnerLanguage, trackingThresholdMinus,
