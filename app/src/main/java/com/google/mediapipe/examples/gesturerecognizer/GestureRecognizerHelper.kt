...
class GestureRecognizerHelper(
    ...
    var currentTask: Int = ASL,
    var runningMode: RunningMode = RunningMode.IMAGE,
    val context: Context,
    val gestureRecognizerListener: GestureRecognizerListener? = null,
    val spellCheckerHelper: SpellCheckerHelper = SpellCheckerHelper(context)
) {
    ...
    fun setupGestureRecognizer() {
        ...
        when (currentTask) {
            ...
            ASL -> { baseOptionBuilder.setModelAssetPath("ASL.task")
                spellCheckerHelper.loadSpellCheckerFromAssets("words.txt", "asl.ser")
                Log.d("spell",spellCheckerHelper.totalWords().toString())
            }

            ARSL -> baseOptionBuilder.setModelAssetPath("ArSL.task")
            FSL -> { baseOptionBuilder.setModelAssetPath("ASL.task")
                spellCheckerHelper.loadSpellCheckerFromAssets("words.txt", "bk_tree.ser")
                Log.d("spell",spellCheckerHelper.totalWords().toString())
            }
            else -> { baseOptionBuilder.setModelAssetPath("ASL.task")
                spellCheckerHelper.loadSpellCheckerFromAssets("words.txt", "bk_tree.ser")}
        }
